...
export default function SocialShare({ url, title }: SocialShareProps) {
  ...
  return (
    <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
      <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">اشتراک‌گذاری:</h3>
      <div className="flex flex-wrap gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-12 h-12 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors"
