/**
 * Website Auto Start/Stop API
 * POST: Start/Stop Website auto processing
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    await prisma.unifiedRSSSettings.update({
      ...
      data: {
        website_auto_start: action === 'start',
        updated_at: new Date(),
      },
    });
    ...
    // if (action === 'start') {
    //   await startRSSScheduler('website');
    // } else {
    //   await stopRSSScheduler('website');
    // }
