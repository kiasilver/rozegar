...
export const metadata: Metadata = {
  title: 'اینفوگرافی | سایت خبری',
  description: 'اینفوگرافی‌های خبری',
  alternates: {
...
export default async function InfographicPage({ searchParams }: PageProps) {
  ...
  // Build where clause - همه خبرها با عکس (بدون نیاز به ویدیو)
  let whereClause: any = {
    is_active: true,
    status: 'PUBLISHED',
    image: {
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <p className="text-base sm:text-lg text-gray-600">
                اینفوگرافی‌های خبری ({totalPosts.toLocaleString('fa-IR')} مورد)
              </p>
            </div>
            ...
            {posts.length > 0 ? (
              ...
              <div className="text-center py-8 sm:py-12">
                <p className="text-base sm:text-lg text-gray-600">اینفوگرافی‌ای یافت نشد.</p>
              </div>
            )}
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-1 sm:gap-2 mt-6 sm:mt-8 flex-wrap">
                {currentPage > 1 && (
                  <Link
                    href={`/infographic?page=${currentPage - 1}`}
